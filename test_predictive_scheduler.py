...
def test_scheduler_active_channels_now():
...
def test_scheduler_fast_track_trigger():
    ...
    assert "UC_FAST" not in scheduler.get_active_channels_now(out_dt)
    ...
    assert "UC_FAST" in active


def test_scheduler_poll_channel_via_api():
    ...
    assert detected_calls[0] == ("UC_TEST", "VID_123", "API_PREDICTIVE")
