...
class UpdaterTests(unittest.TestCase):
    ...
    def test_check_update_returns_release_metadata(self):
        ...
        self.assertEqual(result["latest_version"], "1.0.9")
        self.assertEqual(result["release_name"], "Phiên bản 1.0.9")
