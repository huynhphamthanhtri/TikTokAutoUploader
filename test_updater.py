...
class UpdaterTests(unittest.TestCase):
    ...
    def test_check_update_returns_release_metadata(self):
        release = {
            "tag_name": "v1.0.12",
            "name": "Phiên bản 1.0.12",
            "body": "## Cải thiện\n- Ổn định hơn",
            "html_url": "https://github.com/owner/repo/releases/tag/v1.0.12",
            "published_at": "2026-07-24T00:00:00Z",
            "assets": [{
                "name": "TikTokAutoUploader-v1.0.12.zip",
        ...
        self.assertEqual(result["latest_version"], "1.0.12")
        self.assertEqual(result["release_name"], "Phiên bản 1.0.12")
